...
public class DistribuicaoRotas {
    ...
    public static List<Caminhao> distribuirRotas(List<Integer> rotas, int numCaminhoes) {
        ...
        // Criar uma cópia da lista de rotas
        List<Integer> rotasMutavel = new ArrayList<>(rotas);

        // Ordenar as rotas em ordem decrescente
        rotasMutavel.sort(Collections.reverseOrder());
        ...
        distribuirRecursivo(rotasMutavel, caminhoes, 0);
